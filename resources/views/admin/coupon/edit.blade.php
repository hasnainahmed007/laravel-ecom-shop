								...
								<div class="row">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input value="{{$coupon->min_amount}}" type="text" name="min_amount" id="min_amount" class="form-control" placeholder="Min Discount Amount">
                                            <p></p>		
										</div>
									</div>
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input value="{{$coupon->starts_at}}" type="text" name="starts_at" id="starts_at" class="form-control" placeholder="Start At">
                                            <p></p>		
										</div>
									</div>
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input value="{{$coupon->expire_at}}" type="text" name="expire_at" id="expire_at" class="form-control" placeholder="Expire At">
                                            <p></p>		
										</div>
									</div>
