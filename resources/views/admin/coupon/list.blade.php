					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{route('coupons.create')}}" class="btn btn-primary">New Discountcoupons</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
									...
									<tbody>
                                        @if($discountCoupons->isNotEmpty())
                                          ...
                                          <tr>
											...
											<td>{{(!empty($discountCoupon->expire_at)) ? \Carbon\Carbon::parse($discountCoupon->expire_at)->format('Y/m/d H:i:s') : ''}}</td>
											<td>
