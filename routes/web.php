...
Route::group(['prefix' => 'account'],function(){
    ...
    Route::group(['middleware' => 'guest'],function(){
        ...
        Route::post('/process-register',[AuthController::class,'processRegeister'])->name('account.processRegeister');
